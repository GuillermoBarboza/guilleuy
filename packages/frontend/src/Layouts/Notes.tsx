          ...
          <div>
            ...
            <div>
              ...
              <input
                ...
                type="file"
                className="YourFileInputClass"
              />{" "}
              {/* Apply your custom file input class */}
            </div>
            <div>
              <LoaderButton disabled={!validateForm()}>Save</LoaderButton>
              <LoaderButton onClick={handleDelete} disabled={isDeleting}>
                Delete
              </LoaderButton>
            </div>
          </div>
